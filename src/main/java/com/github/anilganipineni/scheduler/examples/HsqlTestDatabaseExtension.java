...
public class HsqlTestDatabaseExtension implements BeforeEachCallback, AfterEachCallback, SchedulerDataSource {
	...
	/**
	 * @see com.github.anilganipineni.scheduler.examples.examples.dao.SchedulerDataSource#dataSourceType()
	 */
	@Override
	...
	/**
	 * @see com.github.anilganipineni.scheduler.examples.examples.dao.SchedulerDataSource#rdbmsDataSource()
	 */
	@Override
	...
	/**
	 * @see com.github.anilganipineni.scheduler.examples.examples.dao.SchedulerDataSource#cassandraDataSource()
	 */
	@Override
