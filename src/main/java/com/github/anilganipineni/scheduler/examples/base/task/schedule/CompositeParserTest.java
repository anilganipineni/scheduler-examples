...
import com.github.anilganipineni.scheduler.examples.base.task.schedule.ScheduleParsersHelper.FakeParser;
...
import static com.github.anilganipineni.scheduler.examples.base.task.schedule.ScheduleParsersHelper.ANY_SCHEDULE_STRING;
import static com.github.anilganipineni.scheduler.examples.base.task.schedule.ScheduleParsersHelper.DAILY_AT_MIDNIGHT;
import static com.github.anilganipineni.scheduler.examples.base.task.schedule.ScheduleParsersHelper.DAILY_AT_NOON;
import static com.github.anilganipineni.scheduler.examples.base.task.schedule.ScheduleParsersHelper.DAILY_PARSER;
import static com.github.anilganipineni.scheduler.examples.base.task.schedule.ScheduleParsersHelper.FIXED_DELAY_PARSER;
import static com.github.anilganipineni.scheduler.examples.base.task.schedule.ScheduleParsersHelper.THROWING_PARSER;
import static com.github.anilganipineni.scheduler.examples.base.task.schedule.ScheduleParsersHelper.assertScheduleNotPresent;
import static com.github.anilganipineni.scheduler.examples.base.task.schedule.ScheduleParsersHelper.assertSchedulePresent;
